...
if __name__ == "__main__":
    ...
    file_dir = os.path.join(current_dir,
                            "../../datasets/pcba128/classification/pcba128_BinaryLabel_ecfp1024.csv.zip")
    data_name = 'binaryECFP'
    label_colname = 'pcba-' + aid # label column name of one target
    ...
    # continuous ecfp1024
    file_dir = os.path.join(current_dir,
                            "../../datasets/pcba128/regression/pcba128_ContinuousLabel_ecfp1024.csv.zip")
    data_name = 'contECFP'
    ...
    # binary MACCSkeys
    file_dir = os.path.join(current_dir,
                            "../../datasets/pcba128/classification/pcba128_BinaryLabel_MACCSkeys167.csv.zip")
    ...
    file_dir = os.path.join(current_dir,
                            "../../datasets/pcba128/regression/pcba128_ContinuousLabel_MACCSkeys167.csv.zip")
    ...
    result.to_csv(dir_to_store_result + 'each_target_cv_result/' + aid + "_cv_result.csv")

    # collect test result
    result = pd.concat(test_result_list,axis = 0,ignore_index=False)
    result.to_csv(dir_to_store_result + 'each_target_test_result/' + aid + "_test_result.csv")
