...
all_files = glob.glob( dir_to_store_result + 'each_target_cv_result/' + "*_cv_result.csv")
...
cv_result.to_csv(dir_to_store_result + "tox21_cv_result.csv")

# test result
all_files = glob.glob( dir_to_store_result + 'each_target_test_result/' + dataset_name + "*_test_result.csv")
base = pd.read_csv(all_files[0])
target_name = re.sub(dir_to_store_result + 'each_target_test_result/','',all_files[0])
